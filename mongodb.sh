...
workdir /tmp/setting/
DOCKERFILE_EOF
docker run --network my-server --name mongo_server -v  /Volumes/priavte/develop/tibot/db/:/data/db -d -p 16010:27017 -e MONGO_INITDB_ROOT_USERNAME=root -e MONGO_INITDB_ROOT_PASSWORD=asdd mongo_server --auth
